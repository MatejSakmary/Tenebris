...
DAXA_TASK_USE_IMAGE(_g_albedo, REGULAR_2D, FRAGMENT_SHADER_READ)
DAXA_TASK_USE_IMAGE(_g_normals, REGULAR_2D, FRAGMENT_SHADER_READ)
DAXA_TASK_USE_IMAGE(_g_world_pos, REGULAR_2D, FRAGMENT_SHADER_READ)
DAXA_TASK_USE_IMAGE(_esm, REGULAR_2D, FRAGMENT_SHADER_READ)
